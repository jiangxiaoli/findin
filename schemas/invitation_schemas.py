...
class InvitationSchema(Schema):
    ...
    inviter = fields.Nested(UserSchema, only=["id", "firstName", "lastName", "headline", "pictureUrl"])
    invitee = fields.Nested(UserSchema, only=["id", "firstName", "lastName", "headline", "pictureUrl"])
